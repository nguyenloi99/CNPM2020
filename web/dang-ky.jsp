<%@ page import="vn.nlu.cnpm.model.QuanLiKhachHang" %>
<!DOCTYPE html>
<html lang="vn">
...
%>
<!-- Mirrored from demo5019.web30s.vn/dang-ky by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jun 2020 11:12:31 GMT -->
<!-- Added by HTTrack -->
<meta http-equiv="content-type" content="text/html;charset=UTF-8"/><!-- /Added by HTTrack -->
<head>


    <link rel="canonical" href="dang-ky.jsp"/>
    ...
    <meta name="generator" content="Đăng ký thành viên"/>
    <meta name="rating" content="General">
    <meta property="og:url" content="dang-ky.html">
...
<div class="cbp-spmenu-push page page-id-6 home-style1">
                                    ...
                                    <div class="box_register form_container">
                                        <blockquote>
                                                ...
                                                String err = (String) request.getAttribute("Message");
                                                                                            %>
                                                <% if(err!=null){%> <h5 class="text-danger center mg-bottom-15"><%=err%>
                                        </h5><%}%>
                                            <h1 class="title">Đăng ký</h1>


                                            <form class="w30s__form form_register"
                                                  onsubmit="return inputName()&&inputPass()&&inputAcc()&&inputPhone()&&inputMail()&&check()"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-xs-12">
                                                        <div class="group_input">
                                                            <label class="icon required"><i class="fa fa-user-o"
                                                                                            aria-hidden="true"></i></label>
                                                            <input name='fullname' required id="fullname"
                                                    ...
                                                    <div class="col-md-6 col-xs-12">
                                                        ...
                                                        <div class="group_input">
                                                            ...
                                                            <input name='username' id="username"
                                                                   placeholder="Tên truy cập" required
                                                                   onfocus="this.placeholder=''"
                                                ...
                                                <ul class="ls_btn_submit">
                                                    ...
                                                    <li><input type="reset" value="Làm lại"></li>

                                                </ul>
                                            </form>

                                            <p class="orther"></p>
                                            <div style="text-align: center;list-style: none;justify-content: center;    margin: 0;">

                                                <a style="padding-right: 20px" href="">Quên mật khẩu?</a>
    ...
    <script type="text/javascript">
        ...
        function inputName() {
            if (document.getElementById('fullname').value.match(/^.{10,30}$/)) {
                document.getElementById('fullname').style.borderBottom = "1px solid #0bdb08";
                return true;
            } else {
                document.getElementById('fullname').style.borderBottom = "1px solid #db0808";
                return false;
            }
        }
        ...
        var inputPass = function () {
            var name = /(?=^.{8,16}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/
            if (document.getElementById('password').value.match(name)) {
                document.getElementById('password').style.borderBottom = "1px solid #0bdb08";
                // return true;
            } else {
                document.getElementById('password').style.borderBottom = "1px solid #db0808";
                return false;
            }
        }
        var inputPhone;
        inputPhone = function () {
            ...
            if (document.getElementById('phone').value.match(phoneno)) {
                document.getElementById('phone').style.borderBottom = "1px solid #0bdb08";
                return true;
            } else {
                document.getElementById('phone').style.borderBottom = "1px solid #db0808";
                return false;
            }
        };
        var inputMail = function () {
            var mail = /[\w\.\-]{3,}\@[\w]{3,}\.[\w]{2,}/;
            if (document.getElementById('email').value.match(mail)) {
                document.getElementById('email').style.borderBottom = "1px solid #0bdb08";
                return true;
            } else {
                document.getElementById('email').style.borderBottom = "1px solid #db0808";
                return false;
            }
        }
        var inputAcc = function () {
            var name = /(?=^.{8,16}$)(?=[^0-9]{1,2})(?=.*[a-z]).*$/
            if (document.getElementById('username').value.match(name) && !document.getElementById('username').value.match('/./')) {
                document.getElementById('username').style.borderBottom = "1px solid #0bdb08";
                return true;
            } else {
                document.getElementById('username').style.borderBottom = "1px solid #db0808";
                return false;
            }
        }
        var check = function () {
            if (document.getElementById('password').value ==
                ...
                document.getElementById('password_confirm').style.borderBottom = "1px solid #0bdb08";
                return true;
            } else {
                document.getElementById('password_confirm').style.borderBottom = "1px solid #db0808";
                return false;
            }
        }
    </script>
...
<!-- Mirrored from demo5019.web30s.vn/dang-ky by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jun 2020 11:12:33 GMT -->
</html>
